...
class TrainSet(Dataset):
    def __init__(self, source_file, opt=None):
        ...
        with open(source_file, 'r') as f:
            ...
            for i in tqdm(range(i_range)):
                ...
                # 加载数据中过滤掉有误的preselling_shipped_time
                try:
    ...
    def __getitem__(self, idx):
        ...
        return (inputs, targets_sign_day, targets_sign_hour, targets_ship_day, targets_ship_hour, targets_got_day, targets_got_hour, targets_dlved_day, targets_dlved_hour, targets_ship_pay_day)
...
class ValSet(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return (inputs, payed_time, shipped_time, dlved_time, signed_time)
